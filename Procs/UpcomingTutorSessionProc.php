...
try {
    ...
    if ($action == 'accept') {
        ...
        $session->createSession($tutorId, $requestDetails['StudentId'], $requestDetails['RequestDate'], $requestDetails['StartTime'], $requestDetails['Message'],$requestDetails['CourseId']);
