...
// Prepare and execute the query to fetch the tutor's first name
...
$tutorFirstName = $result->fetch_assoc()['FirstName']; // Get the first name of the tutor
...
<body>
    ...
    <h1>Available Sessions for Tutor: <?php echo $tutorFirstName; ?></h1>
